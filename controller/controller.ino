...
void loop()
{
  ...
  case 1: // wipe
    ...
    colorWipe(strip_1, strip_1.Color(255, 0, 0), 50); // Red
    colorWipe(strip_1, strip_1.Color(0, 255, 0), 50); // Green
    colorWipe(strip_1, strip_1.Color(0, 0, 255), 50); // Blue
    break;
  case 2:                                                // chase
    theaterChase(strip_1, strip_1.Color(127, 0, 0), 50); // Red
    theaterChase(strip_1, strip_1.Color(0, 127, 0), 50); // Green
    theaterChase(strip_1, strip_1.Color(0, 0, 127), 50); // Blue
